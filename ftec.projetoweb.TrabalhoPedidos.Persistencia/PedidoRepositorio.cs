        ...
        public void Inserir(Pedido pedido)
        {
            try
            {
                using (var conexao = new NpgsqlConnection(stringConexao))
                {
                    ...
                    sqlCommand.CommandText = "INSERT INTO pedido (id, usuarioid, datapedido, statuspedido) VALUES (@id, @usuarioid, @datapedido, @statuspedido)";
        ...
        public Pedido Procurar(Guid Id)
        {
            try
            {
                ...
                using (var conexao = new NpgsqlConnection(stringConexao))
                {
                    ...
                    sqlCommand.CommandText = "SELECT id, usuarioid, datapedido, statuspedido FROM pedido WHERE id = @id";
                    sqlCommand.Parameters.AddWithValue("id", Id.ToString());
        ...
        public List<Pedido> ProcurarTodos()
        {
            try
            {
                ...
                using (var conexao = new NpgsqlConnection(stringConexao))
                {
                    ...
                    sqlCommand.CommandText = "SELECT id, usuarioid, datapedido, statuspedido FROM pedido";
        ...
        public List<Pedido> BuscarPedidosUsuario(Guid usuarioId)
        {
            try
            {
                ...
                using (var conexao = new NpgsqlConnection(stringConexao))
                {
                    ...
                    sqlCommand.CommandText = "SELECT id, usuarioid, datapedido, statuspedido FROM pedido WHERE usuarioid = @usuarioid";
                    sqlCommand.Parameters.AddWithValue("usuarioid", usuarioId.ToString());
